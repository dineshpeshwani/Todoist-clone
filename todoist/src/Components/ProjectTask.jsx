...
class ProjectTasks extends Component {
  ...
  componentDidMount() {
    ...
    getTasks()
      .then((res) => res.filter((x) => x.projectId == id))
      .then((res) =>
        this.setState({
          tasks: res,
          id 
          ...
          <Box width="80vw" p="2.25rem 4rem 0" float="right">
            <Flex flexDir="column" alignItems="flex-start">
              <Flex w="100%" alignItems="center" justifyContent="space-between">
                ...
                >
                  {" "}
                  <span style={{ fontSize: "0.75rem" }}><span style={{ fontSize: "1.5rem", fontWeight: "normal" }}>Task </span>{`${[today]
                    .toString()
                    .substring(0, 10)}`}</span>
                </Heading>
                <div>
                  ...
                  <Box key={index} w="100%">
                    <Flex alignItems="center" h="40px">
                      <Checkbox
                        ...
                        onChange={(e) => this.handleDelete(e, task.id)}>
              ...
              <ScaleFade initialScale={0.9} in={this.state.setShow}>
                ...
                <Button
                  ...
                  mt="1rem"
                  float="right"
                  onClick={(e) => this.handleSubmit(e, this.state.taskName)}
                >
                  Add Task
                </Button>
              </ScaleFade>
